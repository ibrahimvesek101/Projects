...
ders_adi varchar(30),
yazili_notu int,
CONSTRAINT not_fk FOREIGN KEY(ogrenci_id) REFERENCES ogrenciler(id)
ON DELETE CASCADE);
/*
ON DELETE CASCADE comutu ile parent table'daki record child table silinmeden silinebilir.
...
INSERT INTO notlar VALUES ('104', 'Matematik',90); 
   ...
   delete from ogrenciler where id=104;-- parent table record FK den ON DELETE CASCADE olmazsa dolay silinemz
