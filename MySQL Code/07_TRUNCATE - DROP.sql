...
savepoint ogrencileri_geri_getir;-- bu kpmut tanmlaniği recorddan öncekini yedekler sonraki recordlar yedeklenmez
...
rollback to ogrencileri_geri_getir;-- savepoint deki record lar geri getirldi

truncate table ogrenciler;-- table record kalici silinir rollback çalişmaz
