...
public class C06_MdArrrays {
    public static void main(String[] args) {
        ...
        * TRICK :)İki boyutlu dizilerde tek boyutlu diziler gibi indis değeri 0'dan başlar.
        ...
        System.out.println(arr3[2][3]);//121: 2.kat 3.daire
        //MdArray print etme..
        ...
        System.out.println("Arrays.toString(arr3) = " + Arrays.toString(arr3[2]));//[103, 107, 111, 121]-> arr3 apt 2. katındaki daireleri print
        System.out.println("Arrays.toString(arr3) = " + Arrays.deepToString(arr2[1]));//[103, 107, 111, 121]-> arr3 apt 2. katındaki daireleri print
